...
class Poblacion:
    ...
    def __init__(self,n=0) -> None:
        self.poblacion = [self.Individuo([random.randint(1,8) for j in range(8)]) for i in range(n)]
        self.optimo = None
    ...
    def fitness(self,arr):
        ...
        # El optimo son 28 no colisiones
        return 28 - ataques
    ...
    def optimoEncontrado(self):
        ...
        """
            ...
            La aptitud optima para el problema de las 8_reinas
            es 28

            return: True si se encontro al optimo, False en caso contrario
        """

        return False if self.optimo == None else self.optimo.aptitud == 28
